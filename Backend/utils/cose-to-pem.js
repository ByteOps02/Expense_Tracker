...
const COSEECDHAtoPKCS = (cosePublicKey) => {
  ...
  const oid = Buffer.from([0x06, 0x07, 0x2a, 0x86, 0x48, 0xce, 0x3d, 0x02, 0x01]); // OID for ecPublicKey
  const prime256v1 = Buffer.from([0x06, 0x08, 0x2a, 0x86, 0x48, 0xce, 0x3d, 0x03, 0x01, 0x07]); // OID for prime256v1
