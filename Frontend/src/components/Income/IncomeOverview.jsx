  ...
  return (
    <div className="card w-full"> 
      ...
      <div className="flex lg:hidden bg-gray-100 dark:bg-gray-800 p-1 rounded-lg mb-6">
        ...
        <button 
          className={`flex-1 py-1.5 text-sm font-medium rounded-md transition-all ${chartView === 'source' ? 'bg-white dark:bg-gray-700 text-purple-600 dark:text-white shadow-sm' : 'text-gray-500 dark:text-gray-400'}`}
