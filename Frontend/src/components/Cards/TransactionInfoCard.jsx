...
const TransactionInfoCard = ({
  ...
  return (
    <div className="group relative flex items-center gap-4 mt-2 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700/50 hover:shadow-sm transition-all duration-200 cursor-default border border-transparent hover:border-gray-100 dark:hover:border-gray-600">
      ...
      <div className="flex items-center gap-3">
        {!hideDeleteBtn && (
          <button
            className="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-200 cursor-pointer"
            onClick={onDelete}
          >
            <LuTrash2 size={18} />
          </button>
