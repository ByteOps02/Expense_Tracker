    ...
    >
      <div
        ...
        style={{
          minWidth: "56px",
          minHeight: "56px",
          boxShadow: "0 2px 8px 0 rgba(80, 56, 200, 0.14)",
        }}
      >
        {icon}
      </div>
      <div className="flex flex-col justify-center">
        <h6 className="text-base text-gray-500 mb-1 font-medium tracking-wide">
          {label}
        </h6>
        <span className="text-[26px] font-bold text-gray-900 drop-shadow-sm">
          {value}
        </span>
      </div>
