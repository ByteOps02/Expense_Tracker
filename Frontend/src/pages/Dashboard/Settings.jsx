  ...
  return (
    <DashboardLayout activeMenu="Settings">
      <div className="p-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 max-w-2xl transition-colors duration-300">
